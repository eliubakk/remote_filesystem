...
int main(int argc, char *argv[]){
	...
	fs_create("user1", "password1", session, seq++, "/home/Music/edm.mp3", 'd');
	assert(fs_readblock("user1", "password1", session, seq++, "/home/Music/edm.mp3", 0, readdata) == -1);
	assert(fs_writeblock("user1", "password1", session, seq++, "/home/Music/edm.mp3", 0, writedata) == -1);
